...
"""
system_cot_gt="""You have known the answer that the score of this text is ##{score} ##, but you still need to follow the instruction and reason step by step to make the conclusion"""
