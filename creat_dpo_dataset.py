...
for type_name in type_names:
    for i in range(5):  # 假设有 5 折交叉验证
        ...
        df['truncated_tex'] = df['truncated_tex'].apply(lambda x: str(x))
        
        # 提取人类输入、更优回答和更差回答
        humans = df['truncated_tex'].tolist()          # 人类输入
        ...
        # 输出路径
        output_path = f"/mnt/afs1/panhaojun/project/LLaMA-Factory/data/aes_{type_name}_{fold_name}_dpo.json"
